...
* A total of 10,871 cases and 276 deaths have been reported by the WHO. 
...
* In 4 weeks, the total number of cases is projected to reach 10,751 - 10,927 and the total number of deaths is projected to reach 289 - 306 (a 5-12% increase) if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 974 more cases and up to 40 more deaths; see sections 2 and 3 for details).
* The number of active severe cases requiring health care support is projected to be between 16 and 39 more if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, the number of cases is expected to increase in Ituri, Haut-Uele, Sud-Kivu, Nord-Kivu, Sud-Ubangi while it is expected to decrease in Kinshasa (see section 4).
"
