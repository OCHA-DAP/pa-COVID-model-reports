...
* Per the WHO, a total of 14,511 cases and 358 deaths have been reported with the current number of daily new cases standing at 108.9 (7-day average). We note a worsening of the situation since our last update.
* The current number of active severe cases requiring healthcare support is estimated at 481 - 601.
...
* In 4 weeks, we project that an additional 1,452 - 1,884 cases and 48 - 63 deaths will be reported if current NPIs are maintained. 
...
* Lifting the NPIs would lead to a larger number of additional cases and deaths in 4 weeks: up to 2,941 more cases and up to 49 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring hospitalization is projected to decrease by 129 - 139 assuming NPIs are maintained, and to increase by 433 - 675 if NPIs are lifted (see section 3).
"
...
* Every region is projected to be On Track for Containement (green risk level) with the exception of Kinshasa (yellow risk level), despite a likely decrease in incidence (see section 4).
"
