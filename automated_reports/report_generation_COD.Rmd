...
* Per the WHO, a total of 20,692 cases and 630 deaths have been reported with the current number of daily new cases standing at 219.3 (7-day average). We note a worsening of the situation since our last update.
* The current number of active severe cases requiring healthcare support is estimated at 1339 - 1869.
...
* In 4 weeks, we project that an additional 1,995 - 4,272 cases and 119 - 237 deaths will be reported if current NPIs are maintained. 
...
* Lifting the NPIs would lead to a significantly higher number of additional cases and deaths in 4 weeks: up to 44,330 more cases and up to 1340 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring hospitalization is projected to stay roughly constant assuming NPIs are maintained, and to increase by 11354 - 16886 if NPIs are lifted (see section 3).
"
