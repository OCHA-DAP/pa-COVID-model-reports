...
* Per the WHO, a total of 12,986 cases and 336 deaths have been reported with the current number of daily new cases standing at 88.9 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 179 - 234.
...
* The country is on track for containment except for Kinshasa where Community Spread is present (yellow risk level).
* In 4 weeks, we project that an additional 163 - 329 cases and 12 - 18 deaths will be reported if current NPIs are maintained.
...
* Lifting the NPIs would lead to a larger number of additional cases and deaths in 4 weeks: up to 1,867 more cases and up to 47 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring hospitalization is projected to decrease by 140 - 173 assuming NPIs are maintained, and to increase by 130- 264 if NPIs are lifted (see section 3).
"
...
* Every region is projected to be On Track for Containement by 17 Dec 2020 (green risk level).
"
