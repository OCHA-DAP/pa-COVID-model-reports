...
* Per the WHO, a total of 620,620 cases and 13,057 deaths have been reported, an improvement over our last update. The current number of daily new cases stands at 863.4 (7-day average).
* The current number of active severe cases requiring hospitalization is estimated at 2,011 - 2,848.
...
* Even if current NPIs are maintined, we project an increase in the number of daily new cases, with an additional 86,836 - 115,446 cases and 400 - 530 deaths reported in the next four weeks. 
...
* Lifting the NPIs would lead to a markedly sharp increase in cases and deaths (up to 87,973 more cases and up to 289 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* Active severe cases requiring healthcare are projected to reach 2,252 - 3,017 if NPIs are maintained, and to jump to 8,536 - 11,760 if they are lifted (see section 3).
"
