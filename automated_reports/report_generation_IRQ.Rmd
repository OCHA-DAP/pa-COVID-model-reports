...
* Per the WHO, a total of 519,152 cases and 11,670 deaths have been reported with the current number of daily new cases standing at 2,943 (7-day average).
* The current number of active severe cases requiring hospitalization is estimated at 3,316 - 4,258.
* Progress towards containment is insufficient: the entire country except for Thi Qar is seeing Community or Accelerated Spread (yellow or orange risk levels), or are at Tipping Point. More intense control efforts are needed (see section 2).
* We note that an awareness campaign began on 12 Oct. The other mitigation measure currently in place is face mask wearing (25% compliance). Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In 4 weeks, we project that an additional 164,049 - 209,506 cases and 3,003 - 3,828 deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 141,760 more cases and up to 1,818 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* Active severe cases requiring healthcare are projected to increase by 6,870 - 9,372 (see section 3) assuming NPIs are maintained.
"

key_messages_subnational_projections <- "
* In the next two weeks, the situation in the country is projected to worsen and require more intense control strategies (see section 4). 
* Case incidence (new daily cases per 100,000 people) is projected to increase in every region with Baghdad showing the largest increase (see section 4). 
"
```
