...
* Per the WHO, a total of 409,358 cases and 9,970 deaths have been reported with the current number of daily new cases standing at 62.7 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 1,833 - 2,515.
* Progress towards containment is insufficient: cases continue to climb sharply and the entire country is seeing Community Spread or Accelerated Spread, therefore demanding more intense control efforts (see section 2).
* After taking into consideration case reporting rate, some regions are considered at a Tipping Point (highest level of risk) and requiring highest intensity of control efforts (section 2).
* We note that the only mitigation measure currently in place is face mask wearing (50% compliance). Please update the ACAPS database if this information is inaccurate or incomplete as it affects the accuracy of projections.
"   

key_messages_national_projections <- "
* In the next 4 weeks, the total number of cases is projected to reach 493,532 - 510,450 and the total number of deaths is projected to reach 12,349 - 12,779 if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 16,917 more cases and up to 430 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring healthcare is projected to reach 4,132 - 5,454 (see section 3).
* Projections under the two scenarios (NPIs maintained vs. lifted) are comparable as only 1 NPI (face mask wearing) is currently in place. This control measure may not be enough to contain the virus.

"

key_messages_subnational_projections <- "
* The country is projected to remain at Yellow and Orange risk levels in two weeks, meaning that community spread is expected to remain problematic and require control strategies (see section 4). 
* Case incidence (new daily cases per 100,000 people) is projected to increase slightly in Baghdad, Al-Anbar, Diyala, Salah Al-Din, Ninewa, and Babil; the rest of the country is projected to see a decrease in incidence (see section 4). 
* Whether increasing or decreasing, certain regions are expected to have Accelerated Spread (orange risk level) and will still require moderate containment strategies.
"
```
