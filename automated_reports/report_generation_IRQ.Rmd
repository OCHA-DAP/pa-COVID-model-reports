...
* Per the WHO, a total of 608,232 cases and 12,944 deaths have been reported, an improvement over our last update. The current number of daily new cases stands at 756.3 (7-day average).
* The current number of active severe cases requiring hospitalization is estimated at 1,576 - 2,666.
* Progress towards containment is insufficient: the entire country is seeing Community or Accelerated Spread (yellow or orange risk levels), while Al-Sulaymaniyah is at a Tipping Point (red risk level). More intense control efforts are critically needed (see section 2).
...
* Even if current NPIs are maintined, we project an increase in the number of daily new cases, with an additional 22,456 - 27,956 cases and 206 - 290 deaths reported in the next four weeks. 
...
* Lifting the NPIs would lead to a markedly sharp increase in cases and deaths (up to 59,440 more cases and up to 219 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* Active severe cases requiring healthcare are projected to reach 1,897 - 2,541 if NPIs are maintained, and to jump to 6,405 - 8,827 if they are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In the next two weeks and assuming NPIs are maintained, the situation in the country is projected to significantly worsen in Baghdad, although most other regions will see slight decreases in incidence. Still, those decreases will not suffice to suppress community spread and regions will remain at a yellow or worse level of risk (see section 4). 
