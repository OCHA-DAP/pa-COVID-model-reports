...
* A total of 327,580 cases and 8,682 deaths have been reported. 
* New reported cases have significantly increased since our last update.
* The current number of severe cases requiring healthcare support is estimated at 6,666 - 11,315.
* The situation in Iraq is very concerning. New reported cases have been on a steady climb since early June. 
* The implemented NPIs do not appear sufficient to reduce the spread of the virus.
* The country is still moving towards its peak. 
"   

key_messages_national_projections <- "
* In the next 4 weeks, the total number of cases is projected to reach 379,502 - 422,376 (a 17-30% increase) and the total number of deaths is projected to reach 10,962 - 11,804 (a 23-32% increase) if current NPIs are maintained.
* Lifting of NPIs would lead to a sharply larger increase in cases and deaths (up to 126,729 more cases and up to 1,547 more deaths; see sections 2 and 3 for details). We strongly advise maintaining the current NPIs and considering additional measures.
* The increase in number of severe cases requiring health care support is projected to slow down unless NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, the number of active cases is expected to decrease significantly in Thi Qar while Baghdad governorate will see the highest incidence (see section 4).
"
```
...
\large \textbf{Case and deaths projections for the next 4 weeks or by `r format(projection_date_4w, "%d %b %Y")`}
...
produceIncreasesTable <- function(subnational_projections_dataframe) {
  subnational_projections %>%
          ...
          slice_head(n = 1) %>% # keep top 5 areas 
