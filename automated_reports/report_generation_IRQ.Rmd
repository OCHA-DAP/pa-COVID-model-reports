...
* Per the WHO, a total of 556,728 cases and 12,340 deaths have been reported with the current number of daily new cases standing at 2,077 (7-day average).
* The current number of active severe cases requiring hospitalization is estimated at 2,545 - 3,389.
* Progress towards containment is insufficient: the entire country is seeing Community or Accelerated Spread (yellow or orange risk levels), or are at a Tipping Point. More intense control efforts are critically needed (see section 2).
...
* In 4 weeks, we project that an additional 71,577 - 89,860 cases and 802 - 982 deaths will be reported if current NPIs are maintained.
* Lifting the NPIs would lead to a sharp increase in cases and deaths (up to 194,906 more cases and up to 929 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* Active severe cases requiring healthcare are projected to increase by an additional 4,716 - 6,275 (see section 3) assuming NPIs are maintained.
"

key_messages_subnational_projections <- "
* In the next two weeks, the situation in the country is projected to worsen with more regions reaching the tipping point (red risk level) even if NPIs are maintained (see section 4). 
* The projected incidence indicates a need for more intense control strategies.
* Case incidence (new daily cases per 100,000 people) is projected to decrease meaningfully in Kirkuk, Al-Sulaymaniyah and Duhok however these regions will still face alarmingly high incidence (see section 4). 
"
```
