...
* A total of 269,578 cases and 7,657 deaths have been reported. 
* New reported cases have increased by 11% and new reported deaths have declined by 1% with respect to last week.
* The current number of severe cases requiring healthcare support is estimated at 8,001 - 13,500.
* According to the data reported by the MOPH and the WHO, the number of new reported cases has steadily increased in the past two weeks and reported deaths have been stable in recent weeks.
* The country may be peaking or is still moving towards its peak in cases.
"   

key_messages_national_projections <- "
* The situation in Iraq is very concerning. In the next 4 weeks, the total number of cases is projected to reach 333,897 - 378,693 (a 24-41% increase) and the total number of deaths is projected to reach 10,480 - 11,443 (a 34-46% increase) if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 131,828 more cases and up to 1,807 more deaths; see sections 2 and 3 for details).
* The number of severe cases requiring health care support is projected to increase, and to do so more significantly if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, the number of active cases is expected to increase significantly in Ninewa (by 21%) and to decrease significantly in Thi Qar (see section 4).
"
```
