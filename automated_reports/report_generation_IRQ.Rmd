...
* Even if current NPIs are maintined, we project an increase in the number of daily new cases, with an additional  {npi_projected_deltas_cases_4w_LOW} - {npi_projected_deltas_cases_4w_HI} cases and {npi_projected_deltas_deaths_4w_LOW} - {npi_projected_deltas_deaths_4w_HI} deaths reported in the next four weeks. 
