...
* Per the WHO, a total of 608,232 cases and 12,944 deaths have been reported with the current number of daily new cases standing at 797.9 (7-day average), an improvement over our last update.
* The current number of active severe cases requiring hospitalization is estimated at 1,584 - 2,697.
* Progress towards containment is insufficient: the entire country is seeing Community or Accelerated Spread (yellow or orange risk levels), while Baghdad is at a Tipping Point (red risk level). More intense control efforts are critically needed (see section 2).
...
* In 4 weeks, we project that an additional 22,456 - 27,956 cases and 206 - 290 deaths will be reported if current NPIs are maintained. 
