...
* Per the WHO, a total of {who_current_cum_cases} cases and {who_current_cum_deaths} deaths have been reported. The current number of daily new cases stands at {who_current_newdaily_7daverage_cases} (7-day average).
...
* Lifting the NPIs would lead to a markedly sharp increase in cases (up to {no_npi_vs_npi_projected_deltas_cases_4W_MAX} more cases; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
