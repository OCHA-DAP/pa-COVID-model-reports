...
* Per the WHO, a total of 455,398 cases and 10,671 deaths have been reported with the current number of daily new cases standing at 3,531.4 (7-day average).
* The current number of active severe cases requiring hospitalization is estimated at 1,485 - 2,334.
* Progress towards containment is insufficient: the entire country is seeing Community Spread or Accelerated Spread (yellow or orange risk levels), requiring more intense control efforts (see section 2).
* After taking into consideration underrreporting, some regions are considered at a Tipping Point (highest level of risk) and requiring the highest intensity of control efforts (section 2).
* We note that an awareness campaign began on 12 Oct. The other mitigation measure currently in place is face mask wearing (50% compliance). Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In 4 weeks, we project that an additional 92,926 - 110,321 cases and 2,208 -2,690 deaths will be reported if current NPIs are maintained.
* The projections are identical under the two scenarios examined, which indicates that currently implemented NPIs will likely be insufficient to curb spread.
* The number of active severe cases requiring healthcare is projected to reach 4,373 - 5,577 (see section 3).
"

key_messages_subnational_projections <- "
* In the next two weeks, the country is projected to remain at Yellow and Orange risk levels, meaning that community spread is expected to remain problematic and require control strategies (see section 4). 
* Case incidence (new daily cases per 100,000 people) is projected to increase in Baghdad, Al-Anbar, Duhok, Ninewa, Kirkuk, Diyala, Salah Al-Din, Maysan, Kerbala, Babil, Erbil, Al-Najaf and Al-Sulaymaniyah; the rest of the country is projected to see a decrease in incidence (see section 4). 
* Whether increasing or decreasing in trend, certain regions are expected to have Accelerated Spread (that is, be at an orange risk level) and to still require moderately intense containment strategies.
"
```
