...
* Per the WHO, a total of 599,126 cases and 12,856 deaths have been reported with the current number of daily new cases standing at 797.9 (7-day average), an improvement over our last update.
* The current number of active severe cases requiring hospitalization is estimated at 1,996 - 3,301.
* Progress towards containment is insufficient: the entire country is seeing Community or Accelerated Spread (yellow or orange risk levels), or is at a Tipping Point. The situation is most severe in Kirkuk, Duhok, Diyala, and Ninewa. More intense control efforts are critically needed (see section 2).
...
* In 4 weeks, we project that an additional 23,780 - 30,013 cases and 246 - 351 deaths will be reported if current NPIs are maintained. 
...
* Lifting the NPIs would lead to a markedly sharp increase in cases and deaths (up to 67,548 more cases and up to 281 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* Active severe cases requiring healthcare are projected to reach 2,196 - 2,935 if NPIs are maintained, and to jump to 7,619 - 10,530 if they are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In the next two weeks and assuming NPIs are maintained, the situation in the country is projected to significantly worsen in Baghdad while many regions will see slight decreases in incidence. Still, those decreases will not suffice to suppress community spread and regions will remain at a yellow or worse level of risk (see section 4). 
