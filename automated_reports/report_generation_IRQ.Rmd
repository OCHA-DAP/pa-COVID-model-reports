...
* Per the WHO, a total of 577,323 cases and 12,614 deaths have been reported with the current number of daily new cases standing at 1,317.9 (7-day average), an improvement over our last update.
* The current number of active severe cases requiring hospitalization is estimated at 3,944 - 7,239.
* Progress towards containment is insufficient: the entire country is seeing Community or Accelerated Spread (yellow or orange risk levels), or are at a Tipping Point. The situation is most severe in Kirkuk, Al-Sulaymaniyah, Duhok, Diyala, and Ninewa. More intense control efforts are critically needed (see section 2).
...
* In 4 weeks, we project that an additional 37,943 - 53,342 cases and 433 - 739 deaths will be reported if current NPIs are maintained. The curve is projected to increase over the next 4 weeks.
* Lifting the NPIs would lead to a markedly sharp increase in cases and deaths (up to 125,857 more cases and up to 683 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* Active severe cases requiring healthcare are projected to decline and reach 3,857 - 5,523 if NPIs are maintained, and to jump to 13,459 - 19,418 if they are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In the next two weeks, the situation in the country is projected to significantly worsen in Baghdad and in Al-Muthanna with one more region reaching Tipping Point (red risk level) assuming NPIs are maintained (see section 4). 
* The projected incidence indicates a need for more intense control strategies.
* Case incidence (new daily cases per 100,000 people) is projected to decrease meaningfully in Kirkuk, Al-Sulaymaniyah and Duhok however these regions will still face alarmingly high incidence requiring the most intense control efforts (see section 4). 
"
```
