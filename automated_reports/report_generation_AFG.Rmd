...
* There is community spread in several parts of the country, according to estimates of true number of cases that adjust for underreporting. Current control efforts should be maintained to counter further spread (see section 2 for detail).
...
* The number of active severe cases requiring healthcare is projected to decrease but still reach {npi_hospitalizations_LOW} - {npi_hospitalizations_HI} if NPIs are maintained. If NPIs are lifted, hospitalizations are expected to remain at approximately 
the current level (see section 3).
"

key_messages_subnational_projections <- "

* In two weeks, the country is projected to continue to see community spread in several areas according to estimates of true number of cases that adjust for underreporting and assume that NPIs will stay in place (see section 4). 
