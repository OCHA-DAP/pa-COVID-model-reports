...
* Per the WHO, a total of 55,121 cases and 2,405 deaths have been reported with the current number of daily new cases standing at 53.0 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 665 - 1,112.
...
* In 4 weeks, we project 984 - 1228 additional cases and 88 - 119 additional deaths will be reported if current NPIs are maintained.
* The trajectory of the crisis depends on whether NPIs are kept in place: lifting of NPIs would lead daily new cases to hold steady or increase rather than decrease if NPIs are maintained. Thus lifting NPIs would result in an increase in cases and deaths by up to 598 more cases and 42 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring healthcare is projected to decrease but still reach 557 - 752 if NPIs are maintained. Hospitalizations may increase if NPIs are lifted (see section 3).
"
