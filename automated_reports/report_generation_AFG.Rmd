...
* Per the WHO, a total of 39,928 cases and 1,480 deaths have been reported with the current number of daily new cases standing at 63.1 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 29 - 51.
* There is community spread in Herat and additional regions according to estimates of true number of cases that adjust for underreporting. Non-pharmaceutical interventions are recommended to control further spread (see section 2 for detail).
* Cases had a first peak in early June and deaths had a first peak in early July. 
* We note the following measures as currently in place: domestic travel restrictions (50% compliance), limits on public gatherings (50% compliance), public health awareness campaigns (50% compliance), and school closures (100% compliance). Please update the ACAPS database if this information is inaccurate or incomplete as it affects the accuracy of projections.
* The data from the WHO and the Ministry of Public health concord well.
"   

key_messages_national_projections <- "
* In 4 weeks, the total number of cases is projected to reach 41,357 - 41,587 and the total number of deaths is projected to reach 1,546 - 1,567 if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 1904 more cases and up to 56 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring healthcare is projected to be at 75 - 96 if NPIs are maintained, with more than twice as many cases if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks, the country is projected to be on track for containment (= green risk level) based on reported data. However community spread is projected to continue in Herat and additional regions according to estimates of true number of cases that adjust for underreporting (see section 4).
* Strategies for containment likely to still be warranted to mitigate spread. 
* The ratio of active cases per 100,000 people is expected to decrease or stay stable across the country assuming all current NPIs are maintained (see section 4).
"
```
