...
* A total of 38,544 cases and 1,420 deaths have been reported. 
* New reported cases have increased by 77% and new reported deaths have declined by 33% with respect to last week.
* The current number of severe cases requiring healthcare support is estimated at 101 - 167.
* According to the data reported by the MOPH and the WHO, the number of new reported cases decreased sharply in late August but have been rapidly increasing since our last update. Reported deaths have been declining for several weeks.
...
* In the next 4 weeks, the total number of cases is projected to reach 39,341 - 39,582 (a 2-3% increase) and the total number of deaths is projected to reach 1,466 - 1,486 (a 3-5% increase) if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 1,219 more cases and up to 44 more deaths; see sections 2 and 3 for details).
* The number of severe cases requiring health care support is projected to increase, and to increase sharply if NPIs are lifted (see section 3).
"
