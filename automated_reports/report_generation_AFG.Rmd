...
cfr <- as.numeric('3.7')
npi_projected_cases_4w_LOW <- format(39063, big.mark = ",")
npi_projected_cases_4w_HI <- format(39560, big.mark = ",")
npi_projected_deaths_4w_LOW <-format(1454, big.mark = ",")
npi_projected_deaths_4w_HI <- format(1490, big.mark = ",")

no_npi_projected_cases_4w_LOW <- format(40107, big.mark = ",")
no_npi_projected_cases_4w_HI <- format(41222, big.mark = ",")
no_npi_projected_deaths_4w_LOW <-format(1475, big.mark = ",")
no_npi_projected_deaths_4w_HI <- format(1526, big.mark = ",")

hospitalizations_current_LOW <- format(120, big.mark = ",")
hospitalizations_current_HI <- format(232, big.mark = ",")
npi_hospitalizations_LOW <- format(152, big.mark = ",")
npi_hospitalizations_HI <- format(270, big.mark = ",")
no_npi_hospitalizations_LOW <- format(384, big.mark = ",")
no_npi_hospitalizations_HI <- format(681, big.mark = ",")
```
...
* A total of 38,071 cases and 1,397 deaths have been reported. 
* New reported cases and deaths have declined by 26% and 81% respectively with respect to last week."   
key_messages_national_projections <- "
* According to the data reported by the MOPH, after a decreasing trend in July the number of new cases has been stable since the beginning of August. 
* Lifting NPIs currently in place would lead to a sharp increase of new cases.
* Our projections suggest an increase in the cumulative number of cases between 3% and 4% and an increase in the cumulative number of deaths up to 7% in the next four weeks, assuming all current NPIs are maintained. Lifting of NPIs would lead to a larger increase (see sections 2 and 3 for details).
* The disease is spreading at a similar rate compared to our previous update, with the number of severe cases still expected to grow in the coming 2 weeks (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, the number of active cases is expected to decrease in all provinces (see section 4).
"
```
