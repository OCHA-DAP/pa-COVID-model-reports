...
subnational_projections_ordered %>%
          mutate(cases_per_100k_abs_change = ifelse(cases_per_100k_abs_change > 0, paste0('+', cases_per_100k_abs_change), cases_per_100k_abs_change)) %>%
          kable(format = 'latex',
          ...
          column_spec(3, width = "2cm", background = ifelse(subnational_projections_ordered$cases_per_100k_inTWOweeks < 1, "#00a67e",
                                             ifelse(subnational_projections_ordered$cases_per_100k_inTWOweeks < 10, "#f8b931",
                                                    ifelse(subnational_projections_ordered$cases_per_100k_inTWOweeks < 25, "#f88c29", "#df431d")))) %>%
