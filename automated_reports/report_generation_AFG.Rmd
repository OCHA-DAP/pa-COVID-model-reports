...
* Per the WHO, a total of 43,240 cases and 1,625 deaths have been reported with the current number of daily new cases standing at 154 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 72 - 138.
* There is community spread in Balkh, Zabul, Kapisa, Bamyan, Takhar, Kunduz, Kandahar, Nimroz and Hirat according to estimates of true number of cases that adjust for underreporting. Non-pharmaceutical interventions are recommended to control further spread (see section 2 for detail).
* Cases had a first peak in early June and deaths had a first peak in early July. 
* We note that public health awareness campaings are the sole containment measure currently in place. Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In 4 weeks, we project 3,850 - 4,533 additional cases and 170 - 222 additional deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 1,899 more cases and up to 79 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring healthcare is projected to be at 177 - 225 if NPIs are maintained, with significantly more cases if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks, the country is projected to continue to see community spread (= yellow risk level) in several regions according to estimates of true number of cases that adjust for underreporting (see section 4).
* Strategies for containment likely to still be warranted to mitigate spread. 
* Assuming NPIs remain in place, Hirat, Kabul, Nangarhar are projected to see an increase in their ratio of daily new cases per 100,000 people while Zabul and Balkh are projected to show decreases. Those two regions are still projected to still face community spread and require mitigation strategies (see section 4).
"
```
