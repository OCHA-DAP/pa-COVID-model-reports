...
* Per the WHO, a total of 46,717 cases and 1,795 deaths have been reported with the current number of daily new cases standing at 206 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 483 - 579.
...
* In 4 weeks, we project 4,506 - 5,609 additional cases and 251 - 304 additional deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to daily new cases to rapidly increase instead of secreasing if NPIs are maintained. That would lead to a larger increase in cases and deaths by up to 2,771 more cases and 103 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring healthcare is projected to sharply increase to 2054 - 2715 if NPIs are maintained, with significantly more cases if NPIs are lifted (see section 3).
"
