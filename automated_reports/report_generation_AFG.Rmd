...
* Per the WHO, a total of 53,105 cases and 2,244 deaths have been reported with the current number of daily new cases standing at 110.7 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 1,368 - 2,468.
* There is community or accelerated spread in most of the country according to estimates of true number of cases that adjust for underreporting. Takhar, Zabul, and Hirat are at a Tipping point (the highest level of risk). More intense control efforts are recommended to counter further spread (see section 2 for detail).
...
* In 4 weeks, we project 2,318 - 2,881 additional cases and 181 - 262 additional deaths will be reported if current NPIs are maintained.
* The trajectory of the crisis depends on whether NPIs are kept in place: lifting of NPIs would lead daily new cases to increase rather than decrease if NPIs are maintained. Thus lifting NPIs would result in a larger increase in cases and deaths by up to 1,340 more cases and 102 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring healthcare is projected to decrease but still reach 1,213 - 1,668 if NPIs are maintained. Hospitalizations may increase if NPIs are lifted (see section 3).
"
...
* Despite a decreasing incidence, most regions are projected to still be facing community or accelerated spread (yellow and orange risk levels) while Zabul and Hirat are projected to be at tipping points (red level of risk; see section 4).
