...
* Per the WHO, a total of 49,703 cases and 2,001 deaths have been reported with the current number of daily new cases standing at 191 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 3080 - 4272.
* There is community or accelerated spread in most of the country according to estimates of true number of cases that adjust for underreporting, as well as several regions at a Tipping point (the highest level of risk). More intense control efforts are recommended to counter further spread (see section 2 for detail).
...
* In 4 weeks, we project 3,910 - 4,987 additional cases and 398 - 472 additional deaths will be reported if current NPIs are maintained.
* The trajectory of the crisis depends on whether NPIs are kept in place: lifting of NPIs would lead daily new cases to rapidly increase instead of decreasing if NPIs are maintained. That would lead to a larger increase in cases and deaths by up to 2,419 more cases and 117 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring healthcare is projected to decrease but still reach 2,518 - 3,368 if NPIs are maintained. Hospitalizations are projected to increase if NPIs are lifted (see section 3).
"
...
* Assuming NPIs remain in place, Paktika, Badakhshan, Nangarhar, and Sar-e-Pul are projected to see an increase in their ratio of daily new cases per 100,000 people.
* Despite a decreasing incidence, all other regions are projected to still be facing community or accelerated spread (yellow and orange risk levels) while Parwan, Baghlan, Balkh, Zabul, Farah, Kapisa and Pansjer are projected to remain at tipping points, the highest level of risk (see section 4).
