...
current_incidence_risk_graph_path <- paste0("../Outputs/", country_iso_3_code, "/map_cases_per_100k_current.png")
...
\large \textbf{Severe cases projections} 
...
\Large \textbf{`r colorize('4. Subnational Projections', 'centreGreen')`} \normalsize (for the next 2 weeks or by `r format(projection_date_2w, "%d %b %Y")`, if current NPIs[^3] maintained)

\large \textbf{`r colorize('Projected Cases', 'centreBlue')`}

\begin{center}
\includegraphics[width=0.5\textwidth]{`r subnational_cases_per_100k_graph_path`}
\end{center}

\large \textbf{`r colorize('Largest Increases and Decreases In New Cases', 'centreBlue')`}
