...
* Per the WHO, a total of 40,937 cases and 1,518 deaths have been reported with the current number of daily new cases standing at 68 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 28 - 65.
* There is community spread in several regions according to estimates of true number of cases that adjust for underreporting. Non-pharmaceutical interventions are recommended to control further spread (see section 2 for detail).
* Cases had a first peak in early June and deaths had a first peak in early July. 
* We note the following measures as currently in place: domestic travel restrictions (50% compliance), limits on public gatherings (50% compliance), public health awareness campaigns (50% compliance), and school closures (100% compliance). Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In 4 weeks, we project 1,159 - 1,530 additional cases and 94 - 135 additional deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 2,547 more cases and up to 118 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring healthcare is projected to be at 90 - 123 if NPIs are maintained, with more than twice as many cases if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks, the country is projected to be on track for containment (= green risk level) based on reported data. However community spread is projected to continue in several regions according to estimates of true number of cases that adjust for underreporting (see section 4).
* Strategies for containment likely to still be warranted to mitigate spread. 
* No increase in the ratio of daily new cases per 100,000 people is expected. Hirat, Kunduz and Takhar are projected to show the largest decreases assuming all current NPIs are maintained (see section 4).
"
```
