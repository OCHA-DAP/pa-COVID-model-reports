...
### ADD ME: total cases and total deaths and most recent date from MOPH
```
...
### ADD ME: MOPH TOTALS FOR COMPARISON: data.frame(Cases = c(10, 100), Deaths = c(3, 30)) 

row.names(x) <- "Reported by WHO"
### ADD ME: ROWNAME FOR MOPH: row.names(x) <- c("Reported by WHO", "Reported by MOPH")
...
#### ADD ME: Projected cases per 100k or daily new cases for every region
