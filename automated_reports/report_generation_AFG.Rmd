...
* Per the WHO, a total of 54,062 cases and 2,343 deaths have been reported with the current number of daily new cases standing at 74.9 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 921 - 1,559.
* There is community spread in most of the country, and accelerated spread in Nimroz and Hirat, according to estimates of true number of cases that adjust for underreporting. TODO: More intense control efforts are recommended to counter further spread (see section 2 for detail).
* TODO: We note that public health awareness campaigns are the sole containment measure currently in place. Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In 4 weeks, we project 1,539 - 1,825 additional cases and 122 - 166 additional deaths will be reported if current NPIs are maintained.
* The trajectory of the crisis depends on whether NPIs are kept in place: lifting of NPIs would lead daily new cases to increase rather than decrease if NPIs are maintained. Thus lifting NPIs would result in a larger increase in cases and deaths by up to 775 more cases and 59 more deaths (see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring healthcare is projected to decrease but still reach 820 - 1,069 if NPIs are maintained. Hospitalizations may increase if NPIs are lifted (see section 3).
"
...
* Despite a decreasing incidence, most regions are projected to still be facing community spread (yellow risk level) while Nimroz and Hirat are projected to have accelerated spread (orange level of risk; see section 4).
* TODO: Strategies for containment should be intensified to mitigate spread.
"
```
