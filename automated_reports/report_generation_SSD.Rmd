...
cfr <- as.numeric('1.9')
npi_projected_cases_4w_LOW <- format(2497, big.mark = ",")
npi_projected_cases_4w_HI <- format(2505, big.mark = ",")
npi_projected_deaths_4w_LOW <-format(47, big.mark = ",")
npi_projected_deaths_4w_HI <- format(47, big.mark = ",")

no_npi_projected_cases_4w_LOW <- format(2561, big.mark = ",")
no_npi_projected_cases_4w_HI <- format(2580, big.mark = ",")
no_npi_projected_deaths_4w_LOW <-format(48, big.mark = ",")
no_npi_projected_deaths_4w_HI <- format(49, big.mark = ",")

hospitalizations_current_LOW <- format(2, big.mark = ",")
hospitalizations_current_HI <- format(3, big.mark = ",")
npi_hospitalizations_LOW <- format(2, big.mark = ",")
npi_hospitalizations_HI <- format(3, big.mark = ",")
no_npi_hospitalizations_LOW <- format(9, big.mark = ",")
no_npi_hospitalizations_HI <- format(14, big.mark = ",")
```
