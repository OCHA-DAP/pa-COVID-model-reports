...
* Per the WHO, a total of 2,798 cases and 55 deaths have been reported with the current number of daily new cases standing at 7.1 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 3 - 4 based on available data.
* Cases had a peak of cases around June.
...
* We note the following measures as currently in place: domestic travel restrictions (50% compliance), curfews (50% compliance), school closures (100% compliance), and limits on public gatherings (50% compliance). Please update the ACAPS database if this information is inaccurate or incomplete as it affects the accuracy of projections.
* We also note concerning data gaps and data quality issues that limit visibility into the current situation and affect
the ability to make projections.
* In the past 4 - 6 weeks, the WHO has reported more cases but fewer deaths than the MOPH.
"   

key_messages_national_projections <- "
* In 4 weeks, the total number of cases is projected to reach up to 2,767 - 2,859 if current NPIs are maintained. 
* Lifting the NPIs would lead to a larger increase in cases in particular (up to 315 more cases and up to 4 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring healthcare is projected to reach 4 - 7 and up to 16 if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
Data gaps and inconsistencies in the reported number of cases and deaths in South Sudan represent major challenges. For this reason no subnational projections are available yet.
"
