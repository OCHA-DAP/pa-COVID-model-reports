...
* The number of active severe cases requiring hospitalization is estimated at 9 - 14 based on available data.
...
* In 4 weeks and based on the available data, we project that an additional 40 - 64 cases and 2 deaths will be reported if current NPIs are maintained.
* Lifting the NPIs would lead to a larger number of cases being added (up to 133 more cases and up to 2 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring hospitalization is projected to reach 6 - 9 and up to 32 if NPIs are lifted (see section 3).
"
