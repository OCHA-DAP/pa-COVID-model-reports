...
* Per the WHO, a total of 2,890 cases and 56 deaths have been reported with the current number of daily new cases standing at 6.14 (7-day average). This rate has decreased since our last update.
* The number of active severe cases requiring hospitalization is estimated at 3 - 4 based on available data.
...
* We note the following measures as currently in place: restrictions on inter-regional movement (50% compliance), social distancing (50% compliance), school closures (100% compliance), and limits on public gatherings (50% compliance). Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In the past 4 weeks, the WHO has reported more cases and deaths than the MOPH.
...
* In 4 weeks, we project that an additional 31 - 52 cases and 4 - 6 deaths will be reported if current NPIs are maintained.
...
* Lifting the NPIs would lead to a larger number of cases being added (up to 170 more cases and up to 9 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 8 weeks later.
* The number of active severe cases requiring hospitalization is projected to be at 2 - 5 and up to 24 if NPIs are lifted (see section 3).
"
