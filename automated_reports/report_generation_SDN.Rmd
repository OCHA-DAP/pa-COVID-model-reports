...
* The number of active severe cases requiring hospitalization is projected to decrease by {npi_hospitalizations_delta_LOW} - {npi_hospitalizations_delta_HI} assuming NPIs are maintained, and to decrease only slightly (by {no_npi_hospitalizations_delta_LOW} - {no_npi_hospitalizations_delta_HI}) if they are lifted (see section 3).
"
