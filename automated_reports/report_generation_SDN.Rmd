...
* In 4 weeks, we project that an additional 2,658 - 5,906 cases and 223 - 386 deaths will be reported if current NPIs are maintained. The curve is projected to climb sharply, indicating a rapid deterioration of the situation.
* Lifting the NPIs would lead to a larger increase in cases and deaths (up to 5,706 more cases and up to 279 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring hospitalization is projected to decrease by 1014 - 1031 assuming NPIs are maintained, and to decrease only slightly (by 84 - 362) if they are lifted (see section 3).
"
