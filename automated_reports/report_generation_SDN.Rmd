...
cfr <- as.numeric('6.3')
npi_projected_cases_4w_LOW <- format(14615, big.mark = ",")
npi_projected_cases_4w_HI <- format(15257, big.mark = ",")
npi_projected_deaths_4w_LOW <-format(966, big.mark = ",")
npi_projected_deaths_4w_HI <- format(1037, big.mark = ",")

no_npi_projected_cases_4w_LOW <- format(14833, big.mark = ",")
no_npi_projected_cases_4w_HI <- format(15505, big.mark = ",")
no_npi_projected_deaths_4w_LOW <-format(975, big.mark = ",")
no_npi_projected_deaths_4w_HI <- format(1051, big.mark = ",")

hospitalizations_current_LOW <- format(285, big.mark = ",")
hospitalizations_current_HI <- format(442, big.mark = ",")
npi_hospitalizations_LOW <- format(429, big.mark = ",")
npi_hospitalizations_HI <- format(670, big.mark = ",")
no_npi_hospitalizations_LOW <- format(492, big.mark = ",")
no_npi_hospitalizations_HI <- format(776, big.mark = ",")
```
...
* A total of 12,974 cases and 819 deaths have been reported. 
* New reported cases and deaths have declined by 12% and 32% respectively with respect to last week.
"   

key_messages_national_projections <- "
* After a decrease in the number of new reported cases in early August, recent trends suggest that new cases are growing, making the situation in Sudan very concerning still.
* The case fatality rate is still significantly higher than expected (6.3%), suggesting a severe underreporting of COVID-19 cases. We estimate that only around 3% of the daily COVID-19 cases are reported by the authorities.
* Our projections suggest an increase in the cumulative number of cases between 13% and 18% and an increase in the cumulative number of deaths up to 24% in the next four weeks, assuming all current NPIs are maintained. 
* Lifting of NPIs would lead to a larger increase (see sections 2 and 3 for details).
* The number of severe cases is expected to grow in the coming two weeks (see section 3).
"

key_messages_subnational_projections <- "
* The number of active cases is expected to grow in all the States. 
* Aj Jazirah, Khartoum, Gedaref, North Kordofan and Kassala are projected to have the highest increase in two weeks time, assuming all current NPIs are maintained.
"
```
