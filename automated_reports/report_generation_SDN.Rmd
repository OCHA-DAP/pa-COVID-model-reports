...
* The subnational data from MOPH is inconsistent with the numbers reported by WHO. Please keep mind that the projections are based on subnational data, and our current assessment of the situation and all projections depend on the data being complete and accurate.
...
* Strategies for containment should be maintained to continue the reduce the amount of community transmission.
"
