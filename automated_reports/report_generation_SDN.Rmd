...
* Per the WHO, a total of 14,626 cases and 1116 deaths have been reported with the current number of daily new cases standing at 60 (7-day average). We note that 279 deaths were reported since our last update, which may be due to delays in reporting.
* The number of active severe cases requiring hospitalization is estimated at 70 - 82.
* Case Fatality Rate has increased to a concerning 7.6%, which may partly due to underreporting. We note another improvement in estimated case reporting rate from 23% to 31%.
* According to the data reported by the MOPH and WHO, the country is on track for containment with fewer than 1 case per 100,000 people in every state. However Khartoum is seeing community spread when looking at estimates of true number of cases that adjust for underreporting.
* We note the following measures as currently in place: limits on public gatherings (25% compliance), border closings (25% compliance), and partial lockdown (25% compliance). Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
...
* In 4 weeks, we project that an additional 1,429 - 1,774 cases and 137 - 163 deaths will be reported if current NPIs are maintained.
* Projections under the two scenarios (NPIs maintained vs. lifted) are similar, suggesting that the NPIs currently in place may not suffice to mitigate spread (see sections 2 and 3 for details). Still lifting NPIs would lead to a larger increase in cases and deaths (up to 553 more cases and up to 36 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring hospitalization is projected to stand at 102 - 134 assuming NPIS are maintained (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks incidence across the country is projected to be stable although we note an increasing trend in daily new cases in Khartoum (see section 4).
"
