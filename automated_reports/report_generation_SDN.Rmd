...
* Per the WHO, a total of 13,691 cases and 836 deaths have been reported with the current number of daily new cases standing at 3 (7-day average).
* The current number of active severe cases requiring healthcare support is estimated at 25 - 50.
* Case Fatality Rate remains high at 6.1%, which may partly due to underreporting. We note an improvement in estimated case reporting rate from 3% to 20%.
* According to the data reported by the MOPH and WHO, the country is on track for containment with fewer than 1 case per 100,000 people in every state.
* There is community spread in Red Sea based on estimates of true number of cases that adjust for underreporting.
* We note the following measures as currently in place: limits on public gatherings (30% compliance), border closings (50% compliance), particla lockdown (30% compliance), school closures (100% compliance). Please update the ACAPS database if this information is inaccurate or incomplete as it affects the accuracy of projections.
* The data reported by the WHO suffers from concerning gaps and displays significant variation
...
* In 4 weeks, the total number of cases is projected to reach 14,179 - 14,488 and the total number of deaths is projected to reach 892 - 940 if current NPIs are maintained.
* Lifting of NPIs would lead to a slightly larger increase in cases (up to 6 more cases; see sections 2 and 3 for details).
* Projections under the two scenarios (NPIs maintained vs. lifted) are very similar, suggesting that the NPIs currently in place may not suffice to mitigate the spread of the virus.
* The number of active severe cases requiring healthcare is projected to stand at 41 - 71 (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks the country is projected to remain at the same level of risk as it currently is, that is at the green level except for Red Sea (see section 4).
* Incidence, the number of new daily cases per 100,000 people, is expected to stay stable everywhere but in Red Sea where it is expected to decrease assuming all current NPIs are maintained (see section 4). Maintain control strategies in Red Sea is recommended to address its community spread and be on track for containment.
"
