...
* A total of 13,437 cases and 833 deaths have been reported. 
* New reported cases have declined by 57% while new reported deaths increased by 12% with respect to last week.
* The current number of severe cases requiring healthcare support is estimated at 290 - 456.
* The data reported by the WHO suffers from severe gaps in the last two weeks and displays significant variation from day-to-day. For these reasons it is difficult to assess the stability of trends or whether the country has passed the peak of the crisis.
...
* The situation is increasingly concerning. With consideration for the data limitations discussed above, the total number of cases is projected to reach in the next 4 weeks 15,254 - 15,996 (a 11-16% increase) and the total number of deaths is projected to reach 988 - 1068 (a 13-22% increase) if current NPIs are maintained. 
* Lifting of NPIs would lead to a slightly larger increase (see sections 2 and 3 for details).
* The number of severe cases requiring healthcare support is expected to grow, and to increase more sharply if NPIs are lifted  (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, the number of cases is expected to grow in all regions with Red Sea, Sennar, White Nile, River Nile and Khartoum showing the largest increases (see section 4).
"
```
