...
* Per the WHO, a total of 18,535 cases and 1,271 deaths have been reported with the current number of daily new cases standing at 209.6 (7-day average). 
...
* The number of active severe cases requiring hospitalization is estimated at 3,526 - 4,142.
* Case Fatality Rate stands at a concerning 6.2%, which may partly due to underreporting. 
* According to the data reported by the MOPH and WHO, while some of the country is on track for containment with fewer than 1 case per 100,000 people most regions are seeing community or accelerated spread (yellow and orange risk levels.) 
...
* In 4 weeks, we project that an additional 5,895 - 7,315 cases and 930 - 1,108 deaths will be reported if current NPIs are maintained.
* Lifting the NPIs would lead to a larger increase in cases and deaths (up to 1904 more cases and up to 229 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring hospitalization is projected to stand at 7,114 - 9,472 assuming NPIS are maintained (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks incidence across the country is projected to be stable or to increase with Khartoum, River Nile and White Nile showing the largest increases.
* We note a highly concerning projected incidence in Khartoum (see section 4).
"
