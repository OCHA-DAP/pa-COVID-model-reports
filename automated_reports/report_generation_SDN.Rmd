...
* Per the WHO, a total of 22,082 cases and 1,384 deaths have been reported with the current number of daily new cases standing at 230.6 (7-day average). We note a worsening of the situation since our last update. 
* The number of current severe cases requiring hospitalization is estimated at 2,824 - 3,691.
* Case Fatality Rate stands at a concerning 6.3%, which may partly due to underreporting. We note that the WHO has reported significantly more deaths than the MOPH.
...
* According to the data reported by the MOPH and WHO, while some regions are on track for containment with fewer than 1 case per 100,000 people, most regions are seeing community spread (yellow risk levels.) Khartoum is in the highest level of risk with an estimated incidence at 78.1 cases per 100,000 people.
...
* In 4 weeks, we project that an additional 8,975 - 11,238 cases and 384 - 481 deaths will be reported if current NPIs are maintained. The curve is projected to climb sharply, indicating a rapid deterioration of the situation.
* Lifting the NPIs would lead to a larger increase in cases and deaths (up to 2,878 more cases and up to 109 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases will ultimately result in higher deaths 2 - 4 weeks later.
* The number of active severe cases requiring hospitalization is projected to increase by 662 - 971 assuming NPIs are maintained (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks incidence is projected to increase in Khartoum, Red Sea, Sennar, River Nile, West Kordofan, White Nile, Northern, West Darfur, and Abyei PCA.
