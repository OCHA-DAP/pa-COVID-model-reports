...
* A total of 13,578 cases and 836 deaths have been reported. 
* New daily reported cases and deaths appear to have been stable since our last update.
* The current number of severe cases requiring healthcare support is estimated at 168 - 260, an improvement since our last update.
* The data reported by the WHO suffers from severe gaps in the last four weeks and displays significant variation from day-to-day. This might reflect challenges in data collection and/or batching where multiple days' worth of data are reported at once. For these reasons it is difficult to assess the stability of trends.
* The case fatality rate remains still significantly higher than expected (6.2%), suggesting a severe underreporting of COVID-19 cases. We estimate that only around 3% of the daily COVID-19 cases are reported by the authorities.
* Based on available data, the country saw a peak in cases late May - early June. 
"   

key_messages_national_projections <- "
* The situation remains concerning. With consideration for the data limitations discussed above, the total number of cases is projected to reach in the next 4 weeks 14,730 - 15,185 (a 6-9% increase) if NPIs are maintained, which would represent a slow down since our last update.
* The total number of deaths is projected to reach in the next 4 weeks 934 - 983 (a 7-13% increase) if current NPIs are maintained. 
* Lifting of NPIs would lead to a slightly larger increase in cases and deaths (see sections 2 and 3 for details).
* The number of severe cases requiring healthcare support is expected to grow and increase more rapidly if NPIs are lifted  (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, the number of cases is expected to grow in West Darfur, North Kordofan, River Nile, Gedaref and Khartoum, with Karthoum showing the largest increase (see section 4).
"
```
