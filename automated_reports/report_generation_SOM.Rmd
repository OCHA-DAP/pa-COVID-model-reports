...
* A total of 3,745 cases and 99 deaths have been reported by the WHO. 
* The current number of severe cases requiring healthcare support is estimated at 48 - 77.
* Progress towards containment is insufficient in certain areas. Regions vary in the intensity of control effort needed to achieve containment (see section 2).
...
* In the next 4 weeks, the total number of cases is projected to reach 4,128 and the total number of deaths is projected to reach 4,249 if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases and deaths (up to 874 more cases and up to 33 more deaths; see sections 2 and 3 for details).
* The number of severe cases requiring healthcare is projected to increase sharply if NPIs are lifted (see section 3).
"
...
* The ratio of active cases per 100,000 people is expected to increase the most in Togdheer, Wooqooyi Galbeed and Sool assuming all current NPIs are maintained. Note that Bari and Nugaal are projected to stay at concerningly high incidence rates (see section 4).
"
```
