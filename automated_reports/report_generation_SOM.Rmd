...
* Please keep mind that the current assessment of the situation and all projections depend on complete, accurate data. We are concerned there might be severe underreporting in the country: nearby countries report rates of 1.3 (Djibouti), 3.3 (Ethiopia), and 1.5 (Kenya) weekly number of new cases per 100,000 people while Somalia reports 0.2. If reports underrepresent the severity of the crisis, the model will underestimate the magnitude and might erroneously predict the path of the disease even after accounting for some underreporting. 

* Per the WHO, a total of {who_current_cum_cases} cases and {who_current_cum_deaths} deaths have been reported to date with no new cases reported in the last 7 days. 
...
* Based on the reports from the WHO and MOPH, the country is on track for containment (see section 2). However we are concerned about likely underreporting that may hide the true severity of the crisis.
...
* In 4 weeks, we project that an additional  {npi_projected_deltas_cases_4w_LOW} - {npi_projected_deltas_cases_4w_HI} cases and about one death will be reported if current NPIs are maintained.

* Lifting of NPIs would lead to a larger increase in cases in particular (up to {no_npi_projected_deltas_cases_4w_MAX}; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 4 weeks later.

* The number of severe cases requiring hospitalization is projected to decrease and reach {npi_hospitalizations_LOW} - {npi_hospitalizations_HI} if NPIs are maintained, and to slightly increase to {no_npi_hospitalizations_LOW} - {no_npi_hospitalizations_HI} if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "

* In two weeks the country is projected to stay stable in terms of risk levels (green across the country; see section 4) assuming current NPIs are maintained. We reiterate that the crisis may be more severe but data gaps prevent us from having a more complete assessment of the situation.

* All regions are expected to stay stable or see their incidence decrease (see section 4).
"
```
