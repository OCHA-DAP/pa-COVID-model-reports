...
* Per the WHO, a total of 4,784 cases and 130 deaths have been reported to date with the current number of daily new cases standing at 4.3 (7-day average). 
* The number of active severe cases requiring hospitalization is estimated at 22 - 29.
...
* In 4 weeks, we project that an additional 73 - 91 cases and about one death will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases in particular (up to 38 more cases; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 4 weeks later.
* The number of severe cases requiring hospitalization is projected to decrease and reach 16 - 21 if NPIs are maintained, and to slightly increase to 24 - 32 if NPIs are lifted (see section 3).
"
