...
* Per the WHO, a total of 3,941 cases and 104 deaths have been reported to date with the current number of daily new cases standing at 11.0 (7-day average). 
* The number of active severe cases requiring hospitalization is estimated at 7 - 8.
* Cases saw a peak in cases in May-June.
* We note the following measures as currently in place: border closures (50% compliance), curfews (50% compliance), school closures (100% compliance), and limits on public gatherings (50% compliance). By contrast school closures were lifted in June. Please email us (leonardo.milano@un.org) if this information is inaccurate or incomplete as it affects the accuracy of projections.
* Based on the reports from the WHO and MOPH, the country is on track for containment of COVID-19 in every region (see section 2).
...
* In 4 weeks, we project that an additional 128 - 176 cases and 11 - 13 deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases in particular (up to 492 more cases and up to 12 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 8 weeks later.
* The trajectory of the outbreak is projected to change based on whether NPIs are maintained: daily new cases are expected to continue to decline if NPIs are maintained and to start climbing sharply if NPIs are lifted. 
* The number of active severe cases requiring hospitalization is projected to reach 7 - 8 and to increase five- to eight-fold if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks the country is projected to stay stable in terms of risk levels (green across the country; see section 4) assuming current NPIs are maintained. We reiterate that lifting NPIs would likely cause a jump in cases and may result in regions falling into higher risk levels.
* Incidence, the number of daily new cases per 100,000 people, is expected to decrease in Banadir, Awdal, Woqooyi Galbeed, Togdheer, Sool and Sanaag assuming all current NPIs are maintained (see section 4).
"
```
