...
* A total of 3,362 cases and 97 deaths have been reported. 
* New reported cases have declined by 46% with respect to last week. Since our last update 4 new deaths were reported after an absence of deaths reported by the WHO since 14 July 2020.
* The current number of severe cases requiring healthcare support is estimated at 13 - 21.
* The data reported by the WHO suffers from severe gaps and displays significant variation from day-to-day. For these reasons it is difficult to assess the stability of trends or whether the country has passed the peak of the crisis.
"   

key_messages_national_projections <- "
* In the next 4 weeks, the total number of cases is projected to reach 3,521 - 3,554 (a 5-6% increase) and the total number of deaths is projected to reach 105 - 109 (a 7-10% increase) if current NPIs are maintained.
* Lifting of NPIs would lead to a sharper increase in cases and deaths (up to 395 more cases and up to 13 more deaths; see sections 2 and 3 for details).
* The number of severe cases requiring health care support is projected to increase, and to increase more if NPIs are lifted (see section 3).
"

key_messages_subnational_projections <- "
* Assuming all current NPIs are maintained, subnational projections suggest that Nugaal, Bari, Middle Juba, Lower Juba and Gedo will show the largest decreases (see section 4).
"
```
