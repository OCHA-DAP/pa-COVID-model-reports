...
cfr <- as.numeric('2.8')
npi_projected_cases_4w_LOW <- format(3302, big.mark = ",")
npi_projected_cases_4w_HI <- format(3325, big.mark = ",")
npi_projected_deaths_4w_LOW <-format(96, big.mark = ",")
npi_projected_deaths_4w_HI <- format(97, big.mark = ",")

no_npi_projected_cases_4w_LOW <- format(3367, big.mark = ",")
no_npi_projected_cases_4w_HI <- format(3438, big.mark = ",")
no_npi_projected_deaths_4w_LOW <-format(97, big.mark = ",")
no_npi_projected_deaths_4w_HI <- format(100, big.mark = ",")

hospitalizations_current_LOW <- format(3, big.mark = ",")
hospitalizations_current_HI <- format(6, big.mark = ",")
npi_hospitalizations_LOW <- format(4, big.mark = ",")
npi_hospitalizations_HI <- format(9, big.mark = ",")
no_npi_hospitalizations_LOW <- format(18, big.mark = ",")
no_npi_hospitalizations_HI <- format(34, big.mark = ",")
```
...
* A total of 3,269 cases and 93 deaths have been reported. 
* New reported cases have declined by 55% with respect to last week.
* No new deaths have been reported by WHO since 14 July.
"   

key_messages_national_projections <- "
* According to the data reported by the MOPH, after a decreasing trend the number of new cases is expected to remain constant in the next four weeks. 
* A 1-2% projected increase in total cases assuming all current NPIs are maintained. 
* An up to 3% projected increase in total deaths assuming all current NPIs are maintained. 
* Lifting of NPIs would lead to a larger increase in cases and deaths (see sections 2 and 3 for details).
* Despite the lower relative predicted increase, the number of severe cases is expected to grow in the coming 4 weeks (see section 3).
"

key_messages_subnational_projections <- "
* Our subnational projections show that in all regions the number of active cases is expected to decrease slightly (see section 4).
* Bari, Nugaal and Middle Juba are projected to show the largest decrease.
"
```
