...
* Per the WHO, a total of 4,579 cases and 121 deaths have been reported to date with the current number of daily new cases standing at 0 (7-day average). We note that no new deaths were reported since our last update and that the current 7-day average might reflect underreporting.
* The number of active severe cases requiring hospitalization is estimated at 36 - 46.
...
* Based on the reports from the WHO and MOPH, the country is on track for containment (see section 2).
...
* In 4 weeks, we project that an additional 174 - 218 cases and 4 - 5 deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases in particular (up to 136 more cases; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 4 weeks later.
* The trajectory of the outbreak is projected to change based on whether NPIs are maintained: daily new cases are expected to decline if NPIs are maintained and to climb if NPIs are lifted. 
* The number of severe cases requiring hospitalization is projected to reach decrease and reach 26 -35 if NPIs are maintained, and increase to 40 -54 if NPIs are lifted (see section 3).
"
...
* Incidence, the number of daily new cases per 100,000 people, is expected to slightly increase in Lower Shabelle assuming all current NPIs are maintained. All other regions are expected to stay stable or see their incidence decrease (see section 4).
"
```
