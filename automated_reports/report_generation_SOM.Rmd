...
* Please keep mind that the current assessment of the situation and all projections depend on complete, accurate data. We are concerned there might be severe underreporting in the country: nearby countries report rates of 3.7 (Djibouti), 2.4 (Ethiopia), and 1.6 (Kenya) weekly number of new cases per 100,000 people while Somalia reports 0.2. If reports underrepresent the severity of the crisis, the model will underestimate the magnitude and might erroneously predict the path of the disease even after accounting for some underreporting. 
* Per the WHO, a total of 4,714 cases and 131 deaths have been reported to date with the current number of daily new cases standing at 3.4 (7-day average). 
* The number of active severe cases requiring hospitalization is estimated at 23 - 31.
...
* In 4 weeks, we project that an additional 75 - 93 cases and 2 - 3 deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases in particular (up to 55 more cases; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 4 weeks later.
* The number of severe cases requiring hospitalization is projected to decrease and reach 17 - 22 if NPIs are maintained, and to increase to 25 - 34 if NPIs are lifted (see section 3).
"
