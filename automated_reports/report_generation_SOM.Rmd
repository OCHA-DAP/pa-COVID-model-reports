...
* Per the WHO, a total of 4,301 cases and 107 deaths have been reported to date with the current number of daily new cases standing at 10 (7-day average). 
* The number of active severe cases requiring hospitalization is estimated at 45 - 52.
...
* Based on the reports from the WHO and MOPH, the country is on track for containment except in: Bari and Nugaal (see section 2).
...
* In 4 weeks, we project that an additional 942 - 1,302 cases and 29 - 36 deaths will be reported if current NPIs are maintained.
* Lifting of NPIs would lead to a larger increase in cases in particular (up to 1,050 more cases and up to 16 more deaths; see sections 2 and 3 for details). Due to the lag between cases and deaths, a larger number of cases would ultimately result in higher deaths 2 - 4 weeks later.
...
* The number of active severe cases requiring hospitalization is projected to reach 38 - 54 if NPIs are maintained (see section 3).
"

key_messages_subnational_projections <- "
* In two weeks the country is projected to stay stable in terms of risk levels (green across the country except for Nugaal and Bari; see section 4) assuming current NPIs are maintained. We reiterate that lifting NPIs would likely cause a jump in cases and may result in regions falling into higher risk levels.
* Incidence, the number of daily new cases per 100,000 people, is expected to increase in Lower Shabelle, Middle Shabelle, and Banadir assuming all current NPIs are maintained (see section 4).
"
```
